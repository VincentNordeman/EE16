...
function start() {
    ...
    const elementHastiget = document.querySelector(".hastighet")
    const elementTid = document.querySelector(".tid");
    const elementRaknaUt = document.querySelectorAll(".raknaUt");
    const elementSvar = document.querySelectorAll(".svar");
    ...
    function raknaUt() {
        ...
        var hastighet = elementHastiget.textContent;
